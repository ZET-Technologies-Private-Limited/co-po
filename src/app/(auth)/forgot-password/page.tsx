            ...
            <motion.div key="s1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between text-xs font-mono">
                  ...
                  {resendTimer > 0
                    ...
                    : (
                      <button onClick={resendOtp} className="flex items-center gap-1.5 text-brand hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-6">
                ...
                <button
                  onClick={submitStep2}
                  disabled={otpTimer === 0}
                  className="flex items-center gap-3 px-8 py-4 bg-white text-black font-medium text-sm hover:bg-white/90 transition-colors disabled:opacity-40"
                >
